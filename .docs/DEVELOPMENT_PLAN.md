...
| 기간 | 목표 | 관련 Phase |
|------|------|------------|
| ~ 2026-04-01 | 설계 발표. 전체 요구사항을 설계 문서에 반영 | 설계 단계 |
| ~ 2026-04-29 (중간 발표) | 직접 설정 기능 완성 (UC-W01-A~D, ChoiceMappingService) | Phase 1~3 |
| 2026-04-29 ~ 2026-06-17 (최종 제출) | AI 학습 및 채팅형 생성 기능 구현 (UC-W02) | Phase 4~6 |
